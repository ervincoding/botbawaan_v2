...
const dtod = "6283115824395@s.whatsapp.net"
...
{ remoteJid: "6283115824395-1613049930@g.us" } : {})
},
message: { 
"videoMessage": { 
"title": `${tampilUcapan}`,
...
try {
		...
		const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = index.prepareMessageFromContent(from, {
                "listMessage": {
                    "title": title,
                    "description": desc,
            ...
            return index.relayWAMessage(po, {
                waitForAck: true
            })
        }
		const isUrl = (url) => {
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        const katalog = (teks) => {
            res = index.prepareMessageFromContent(from, {
                "orderMessage": {
                    "message": teks,
                    "footerText": "*_© By: RanggaBotzz_*",
                    "thumbnail": ofrply,
                    "surface": 'CATALOG'
                }
            }, {
        ...
        const fakegroup = (teks) => {
            index.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`,
                        ...(from ? {
                            remoteJid: "6283115824395-1635442668@g.us"
                        } : {})
                    },
                    message: {
                        "imageMessage": {
        ...
        const grupinv = (teks) => {
            grup = index.prepareMessageFromContent(from, {
                "groupInviteMessage": {
                    "groupJid": '6283115824395-1616169743@g.us',
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `RanggaBotzz`, //Kasih namalu
...
const daftar2 = '```Ketik Tombol Di Bawah Untuk Mendaftar Ke Database RanggaBotzz```'
...
const sendButLocation = async(id, text1, desc1, gam1, but = [], options = {}) => {
            ...
            index.chatRead(from)
            await index.updatePresence(from, Presence.composing)
            anu = await fetchJson(`https://janbot-api.herokuapp.com/api/textpro/graffiti?text=${pushname}`)
               ...
               // ganz = await getBuffer(hooh.result)
                ...
                imageMsg = (await index.prepareMessageMedia(buffer1, 'imageMessage')).imageMessage
                buttonsMessage = {
                    contentText: `*_Halo ${pushname}_* Ketik .menu untuk mengakses bot`,
                    footerText: 'Powered By RanggaBotzz',
                    imageMessage: imageMsg,
                    buttons: buttons,
                    headerType: 4
                }
                prep = await index.prepareMessageFromContent(from, {
                    buttonsMessage
                }, {
                    quoted: fgi
                })
...
if (tebakgambar.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    ...
                    await index.sendMessage(from, btnasu, MessageType.buttonsMessage, {
                        quoted: mek
                    })
...
var ikan = ['🐳','🦈','🐬','🐋','🐟','🐠','🦐','🦑','🦀','🐡','🐙']
 ...
 //function rank 
	    ...
	    if (isCmd && !isGroup) {console.log(color('| RanggaBotzz |', 'greenyellow'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(`${command} [${args.length}]`, 'cyan'), color(`${pushname}`, 'orange'), color(`${sender}`, 'deeppink'))}
...
⚠️ Segala kebijakan dan ketentuan RanggaBotzz di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan RanggaBotzz-
😖🙏

For GitHub : https://github.com/
YouTube index : https://youtube.com/c/
`
sendButLocation(from, `${menu}`, "*RanggaBotzz*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`ping`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
Jika Button Tidak Muncul Ketik .allmenu untuk semua menu atau .simple untuk simple menu`
menu =`By: RanggaBotzz`
gbutsan = [
...
╰────
`
sendButDocument(from, `${menu}`, "*Powered By* RanggaBotzz", fs.readFileSync('./index.jpg'), {mimetype:Mimetype.pdf, thumbnail:ofrply, filename:`By: RanggaBotzz`}, [{buttonId:`about`,buttonText:{displayText:'About 🐋'},type:1},{buttonId:`simple`,buttonText:{displayText:'Simple Menu 🐋'},type:1},{buttonId:`catalog`,buttonText:{displayText:'Katalog Menu 🐋'},type:1}], {quoted:fmen, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Made By Pembuat`,body:`Made By Pembuat`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/`}}})
break
case 'catalog':
...
anu = index.prepareMessageFromContent(from,{
					"productMessage": {
						...
						"businessOwnerJid": `6283115824395@s.whatsapp.net`,
						"contextInfo": {
...
case 'simple':
 stod = `${sender}`
 listMsg = {
 buttonText: 'Simple Menu RanggaBotzz',
 footerText: '*RanggaBotzz Menu*',
 ...
 rows: [
                          {
                           ...
                           {
                              "title": "Owner Bot🐣",
                              "description": 'Owner Bot RanggaBotzz !',
                              "rowId": ""
                           ...
                           {
                              "title": "Source Code⚠️",
                              "description": 'Script / Sc Dari Bot RanggaBotzz',
                              "rowId": ""
...
RanggaBotzz Group Script Base⛱️
...
sendButMessage(from, menu, 'Powered By RanggaBotzz', but)
break
case 'maker':
...
sendButMessage(from, menu, 'By: RanggaBotzz', but)
break
case 'nsfww':
...
break
                ...
                index.sendMessage(from, listMsg, MessageType.listMessage, {
                    contextInfo: {
                        mentionedJid: [stod]
                    },
                    quoted: fgi
...
OTHER-INFO
💬 MyEmail : ${settings.Mail}
💬 Author : index
💬 Hobby : Programer
💬 Website : -
`
sendButImage(from, menu, `*_Powered By RanggaBotzz* ketik .allmenu untuk semua menu`, buffer1, [
{
buttonId: `${prefix}simple`,
buttonText: {
...
case '3d':
                    ...
                    if (args.length == 0) return reply(`Contoh: ${prefix + command} RanggaBotzz Chan`)
                    txt1 = args[0]
                    txt2 = args[1]
...
case 'pornhub':
            ...
            reply (mess.wait)
              ...
              buttonsMessage = {footerText:'By: RanggaBotzz', imageMessage: imageMsg,
              contentText:`Made By Pembuat`,buttons,headerType:4}
...
case 'nsfw':
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						...
						index.sendMessage(from, `By: RanggaBotzz`, text)
...
case 'tebak': {
                ...
                if (args[0] === "lagu") {
                    ...
                    index.sendMessage(from, buffer1, audio, {
                        mimetype: 'audio/mp4',
                        ptt: true,
                        duration: 359996400,
                        quoted: mek
                    ...
                    index.sendMessage(from, buffer1, image, {
                    quoted: fgi,
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                     ...
                     jawaban = result.jawaban
                    await index.sendMessage(from, `Silahkan Tebak 1 Kata Dari Petunjuk Berikut\n\n*${petunjuk}*\n\nWaktu : 60s`, MessageType.text, {
                        quoted: fgi
                    })
                    .then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                     ...
                     petunjuk = result.soal
                     jawaban = result.jawaban
                    await index.sendMessage(from, `Silahkan Tebak Kata Yang Hilang Dari Kalimat Berikut\n\n*${petunjuk}*\n\nWaktu : 60s`, MessageType.text, {
                        quoted: fgi
                    })
                    .then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                     ...
                     petunjuk = result.soal
                     jawaban = result.jawaban
                    await index.sendMessage(from, `Silahkan Tebak Kata Yang Hilang Dari Lirik Berikut\n\n*${petunjuk}*\n\nWaktu : 60s`, MessageType.text, {
                        quoted: fgi
                    })
                    .then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                     ...
                     petunjuk = result.deskripsi
                     jawaban = result.jawaban
                    await index.sendMessage(from, `Silahkan Tebak Jawaban Dari Pertanyaan Cak Lontong Berikut\n\n*${ini_soal}*\n\nWaktu : 60s`, MessageType.text, {
                        quoted: fgi
                    })
                    .then(() => {
...
katalog(menu)
sendButLocation(from, `Hai ${pushname} ☺️`, "*_© RanggaBotzz.ೃ࿐_*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa`,buttonText:{displayText:'SEWA 🎟️'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'stopjadibot':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
try {
...
case 'ss':
             ...
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await index.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'By: RanggaBotzz', imageMessage: imageMsg,
              contentText:`Nih Kak!\nJangan Lupa Subscribe YT RanggaBotzz!`,buttons,headerType:4}
              prep = await index.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              index.relayWAMessage(prep)
              break
                    case 'tiktokdl': 
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `NEXT`},type:1}]
              imageMsg = (await index.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'Made By Pembuat', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              prep = await index.prepareMessageFromContent(from,{buttonsMessage},{quoted: mek})
              index.relayWAMessage(prep)
...
case 'tictactoe':
            case 'ttt':
                ...
                index.sendMessage(from, `*🎳 Memulai Game Tictactoe 🎲*
...
┃💌 : *SERING² DONASI✨*
┃💌 : ==============
┃💌 : Sewa / Beli Ke Nomor Di Bawah
┃💌 : wa.me/${settings.NomorOwner}
┃💌 : ==============
┃💌 : Instagram : _*@Not Found*_
┗━━⬣`
				sendButLocation(from, `${memek}`, ` Poweren By\nRanggaBotzz!!`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'Done 🌌'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
				break
case 'rdp':
case 'vps':
				...
				memek =`index Store Ready Rdp, Vps
...
Minat?Chat
https://wa.me/${settings.NomorOwner}`
				sendButLocation(from, `${memek}`, `Powered By\nRanggaBotzz!!`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'Done 🌌'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
				break
case 'jasrun':
case 'jasarun':
case 'kebutuhanbot':
...
DONASI OM\nSESUNGGUH NYA ORANG YANG MEMBERI LEBIH BAIK DARI MENERIMA ☝\n\nGopay 🎁: 085722146020\nPulsa 📺: 085722146020`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1}]
              imageMsg = (await index.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'RanggaBotzz', imageMessage: imageMsg,
  ...
  //── 「 Pembatas 」 ──//               
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					if (err) return index.sendMessage(from, `root @RanggaBotzz:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
			...
			case 'runtime':
				...
				sendButLocation(from, `${memek}`, `Powered By\nRanggaBotzz!!`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'AUTHOR🍁'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
				break
			case 'setbio':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				if (args.length < 1) return reply('Teksnya?')
...
case 'culik':
 ...
 case 'listgc':
            ...
            case 'groplist':
            case 'grouplist':
                const txs = index.chats.all().filter(v => v.jid.endsWith('g.us')).map(v => `- ${index.getName(v.jid)}\n${v.jid}\n[${v.read_only ? 'Left' : 'Joined'}]`).join`\n\n`
                fakegroup(txs)
                break                			
					default:
		break
